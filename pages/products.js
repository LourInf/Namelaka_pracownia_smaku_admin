...
export default function Products() {
  ...
  return (
    <Layout>
      <Link
        className="bg-custom-magenta text-white font-semibold text-2xl py-3 pb-3.5 px-5 rounded-full inline-flex items-center justify-center  hover:bg-custom-dark-magenta hover:font-bold transition-colors"
        href={"/products/new"}
      >
        +
      </Link>
              ...
              <td>
                <Link href={"/products/edit/" + product._id}>
                  <svg
                    ...
                    strokeWidth={1}
                    stroke="currentColor"
                    className="w-7 h-7 text-stone-400 icon-scale"
                  >
                    <path
                      strokeLinecap="round"
